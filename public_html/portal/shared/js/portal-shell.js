(function(){
  'use strict';
  if(window.GEES_PORTAL_SHELL_REAL_READY) return;
  window.GEES_PORTAL_SHELL_REAL_READY = true;

  const MENUS={
    student:[['Dashboard','/portal/student/dashboard.html','fa-graduation-cap'],['Application','/portal/student/application.html','fa-file-signature'],['Document Vault','/portal/student/document-vault.html','fa-folder-open'],['Pipeline','/portal/student/pipeline.html','fa-route'],['Details','/portal/student/details.html','fa-id-card']],
    agent:[['Dashboard','/portal/agent/dashboard.html','fa-handshake'],['Students','/portal/agent/students.html','fa-users'],['Commissions','/portal/agent/commissions.html','fa-wallet'],['Universities','/portal/agent/universities.html','fa-building-columns'],['Scholarships','/portal/agent/scholarships.html','fa-award'],['Support','/portal/agent/support.html','fa-headset']],
    staff_generic:[['Staff Home','/portal/staff/dashboard.html','fa-user-tie'],['Work Items','/portal/staff/work-items.html','fa-list-check'],['Ekhlas','/portal/staff/ekhlas/dashboard.html','fa-globe-asia'],['Maanisha','/portal/staff/maanisha/dashboard.html','fa-chart-line'],['Rafshan','/portal/staff/rafshan/dashboard.html','fa-wand-magic-sparkles'],['SEO','/portal/staff/seo/dashboard.html','fa-magnifying-glass-chart']],
    ekhlas:[['Dashboard','/portal/staff/ekhlas/dashboard.html','fa-house'],['Work Items','/portal/staff/work-items.html','fa-list-check'],['India Outreach','/portal/staff/ekhlas/india-outreach.html','fa-globe-asia'],['Community Auditor','/portal/staff/ekhlas/community-auditor.html','fa-users-viewfinder'],['Training Manuals','/portal/staff/ekhlas/training-manuals.html','fa-graduation-cap']],
    maanisha:[['Dashboard','/portal/staff/maanisha/dashboard.html','fa-house'],['Work Items','/portal/staff/work-items.html','fa-list-check'],['INTI Benchmarks','/portal/staff/maanisha/inti-benchmarks.html','fa-scale-balanced'],['Revenue Forecast','/portal/staff/maanisha/revenue-forecast.html','fa-chart-line'],['University Vault','/portal/staff/maanisha/university-vault.html','fa-building-columns']],
    rafshan:[['Dashboard','/portal/staff/rafshan/dashboard.html','fa-house'],['Work Items','/portal/staff/work-items.html','fa-list-check'],['Community Manager','/portal/staff/rafshan/community-manager.html','fa-users-gear'],['Reels Library','/portal/staff/rafshan/reels-library.html','fa-clapperboard'],['Strategy Calendar','/portal/staff/rafshan/strategy-calendar.html','fa-calendar-check']],
    seo:[['SEO Dashboard','/portal/staff/seo/dashboard.html','fa-magnifying-glass-chart'],['Work Items','/portal/staff/work-items.html','fa-list-check']],
